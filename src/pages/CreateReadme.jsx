...
export default function CreateReadme() {
  ...
  const aboutFields = [
    ...
    {
      label: "Current project link:",
      name: "currentlyWorkingLink",
  ...
  const socialMediaPlatforms = [
    {
      ...
      key: "githubUsername",
      color: "100000",
      link: `https://github.com/${social.githubUsername}`,
    },
    {
      name: "Twitter",
      icon: "twitter",
      key: "twitterUsername",
      color: "1DA1F2",
      link: `https://twitter.com/${social.twitterUsername}`,
    },
    {
      name: "Codepen",
      icon: "codepen",
      key: "codepenUsername",
      color: "000000",
      link: `https://codepen.io/${social.codepenUsername}`,
    },
    {
      name: "Stackoverflow",
      icon: "stackoverflow",
      key: "stackoverflowUsername",
      color: "FE7A16",
      link: `https://stackoverflow.com/users/${social.stackoverflowUsername}`,
    },
    {
      name: "Codesandbox",
      icon: "codesandbox",
      key: "codesandboxUsername",
      color: "000000",
      link: `https://codesandbox.io/${social.codesandboxUsername}`,
    },
    {
      name: "Kaggle",
      icon: "kaggle",
      key: "kaggleUsername",
      color: "20BEFF",
      link: `https://kaggle.com/${social.kaggleUsername}`,
    },
    {
      name: "Linkedin",
      icon: "linkedin",
      ...
      color: "0077B5",
      link: `https://www.linkedin.com/in/${social.linkedinUsername}/`,
    },
    {
      name: "Instagram",
      icon: "instagram",
      ...
      color: "E4405F",
      link: `https://instagram.com/${social.instagramUsername}`,
    },
    {
      name: "Dribbble",
      icon: "dribbble",
      key: "dribbbleUsername",
      color: "EA4C89",
      link: `https://dribbble.com/${social.dribbbleUsername}`,
    },
    {
      name: "Behance",
      icon: "behance",
      key: "behanceUsername",
      color: "1769FF",
      link: `https://behance.net/${social.behanceUsername}`,
    },
    {
      name: "Medium",
      icon: "medium",
      key: "mediumUsername",
      color: "12100E",
      link: `https://medium.com/${social.mediumUsername}`,
    },
    {
      name: "LeetCode",
      icon: "leetcode",
      ...
      color: "FFA116",
      link: `https://leetcode.com/${social.leetcodeUsername}/`,
    },
    {
      name: "Codechef",
      icon: "codechef",
      ...
      color: "B92B27",
      link: `https://www.codechef.com/users/${social.codechefUsername}`,
    },
    {
      name: "Dev.to",
      icon: "devdotto",
      key: "devdottoUsername",
      color: "0A0A0A",
      link: `https://dev.to/${social.devdottoUsername}`,
    },
    {
      name: "Youtube",
      icon: "youtube",
      key: "youtubeUsername",
      color: "FF0000",
      link: `https://youtube.com/@${social.youtubeUsername}`,
    },
    {
      name: "Hackerrank",
      icon: "hackerrank",
      ...
      color: "2EC866",
      link: `https://www.hackerrank.com/${social.hackerrankUsername}`,
    },
    {
      name: "Codeforces",
      icon: "codeforces",
      ...
      color: "445f9d",
      link: `https://codeforces.com/profile/${social.codeforcesUsername}`,
    },
    {
      name: "Hackerearth",
      icon: "hackerearth",
      key: "hackerearthUsername",
      color: "2C3454",
      link: `https://www.hackerearth.com/${social.hackerearthUsername}`,
    },
    {
      name: "GeeksForGeeks",
      icon: "geeksforgeeks",
      key: "geeksforgeeksUsername",
      color: "298D46",
      link: `https://auth.geeksforgeeks.org/user/${social.geeksforgeeksUsername}`,
    },
  ];
      ...
      <>
        <label className="skill-button">
          <input
            ...
            name={field.name}
            onChange={(e) =>
              setSkills({ ...skills, [field.name]: e.target.checked })
            }
          />
          <img
            title={`${field.label}`}
            src={`https://cdn.jsdelivr.net/gh/devicons/devicon/icons/${field.icon}/${field.icon}-${field.iconStyle}.svg`}
            alt={`${field.name}`}
          />
        </label>
      </>
  ...
  const renderGithubStatsSelect = () => {
    return (
      <select
        name="Style"
        onChange={(e) => setGithubStatsTheme(e.target.value)}
  ...
  useEffect(() => {
    const updatedMarkdown = `${
      introductionData.name ? `# Hi 👋 I am ${introductionData.name}\n` : ""
...
${aboutData.location ? `* 🌍  I'm based in ${aboutData.location}\n` : ""}${
      aboutData.portfolio && aboutData.portfolioLink
        ? `* 🖥️  See my portfolio at [${aboutData.portfolio}](${aboutData.portfolioLink})\n`
        : ""
    }${
      aboutData.currentlyWorking && aboutData.currentlyWorkingLink
        ? `* 👨‍💻  I'm currently working on [${aboutData.currentlyWorking}](${aboutData.currentlyWorkingLink})\n`
        : ""
    }${
      aboutData.email
        ? `* ✉️  You can reach me at [${aboutData.email}](mailto:${aboutData.email})\n`
        : ""
    }${
      aboutData.currentlyLearning
        ? `* 🧠  I'm currently learning ${aboutData.currentlyLearning}\n`
        : ""
    }${
      aboutData.collaborateOn
        ? `* 🤝  I'm open to collaborating on ${aboutData.collaborateOn}\n`
        : ""
...
${coreSkillFields
  .map((skill) =>
    skills[skill.name]
      ? `<a href="${
          skill.link
        }" target="_blank" rel="noreferrer"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/${
          skill.icon
        }/${skill.icon}-${
          skill.iconStyle
        }.svg" width="36" height="36" alt="${skill.name.toUpperCase()}" /></a>\n`
      : ""
  )
  .join("")}${frontendSkillFields
      .map((skill) =>
        skills[skill.name]
          ? `<a href="${
              skill.link
...
${
  githubLanguagesCard
    ? `<a href="http://www.github.com/${social.githubUsername}"><img src="https://github-readme-stats.vercel.app/api/top-langs/?username=mspatel18&langs_count=3&title_color=${colors.title_color}&icon_color=${colors.icon_color}&text_color=${colors.text_color}&bg_color=${colors.bg_color}&hide_border=true" alt="Top Languages"/></a>`
    : ""
}
${
  githubCommitCard
...
${
  buymeacoffeeUsername
    ? `<a href="https://www.buymeacoffee.com/${buymeacoffeeUsername}"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" width="200" /></a>`
    : ""
}
`;
    ...
    <>
      <div className="wrapper">
        <div className="input-container">
          ...
          <div className="socials">{renderSocialInputs()}</div>
          <div className="section-title">Skills</div>
          <h4>Languages</h4>
          <div className="skill-wrapper">{renderCoreSkillsFields()}</div>
          <h4>Frontend</h4>
          <div className="skill-wrapper">{renderFrontendSkillsFields()}</div>
          <h4>Backend & Database</h4>
          <div className="skill-wrapper">{renderBackendSkillsFields()}</div>
          <h4>Frameworks</h4>
          <div className="skill-wrapper">{renderFrameworkSkillsFields()}</div>
          <h4>Other</h4>
          <div className="skill-wrapper">{renderOtherSkillsFields()}</div>
          ...
          <label htmlFor="">
            <input
              type="checkbox"
              defaultChecked="true"
              value={githubStatsCard}
              onChange={(e) => {
                setGithubStatsCard(!githubStatsCard);
              }}
            />{" "}
            Stats card
          </label>
          <label htmlFor="">
            <input
              type="checkbox"
              defaultChecked="true"
              value={githubLanguagesCard}
              onChange={(e) => {
                setGithubLanguagesCard(!githubLanguagesCard);
              }}
            />{" "}
            Languages card
          </label>
          <label htmlFor="">
            <input
              type="checkbox"
              defaultChecked="true"
              value={githubCommitCard}
              onChange={(e) => {
                setGithubCommitCard(!githubCommitCard);
              }}
            />{" "}
            Commit card
          </label>
          <label htmlFor="">
            <input
              type="checkbox"
              onChange={(e) => {
                setGithubGraphCard(!githubGraphCard);
              }}
            />{" "}
            Graph card
          </label>
          <div className="section-title">Support Me</div>
          <div className="input-title  social-desc">
            <img
            ...
            <input
              ...
              onChange={(e) => {
                setBuymeacoffeeUsername(e.target.value);
              }}
            />
          </div>
        </div>
          ...
          <div className="markdown-header">
            <div className="markdown-btn-group">
              <button
                ...
                className={activeBtn ? "markdown-active-btn" : "markdown-btn"}
              >
                Preview
              </button>
              {/* <div className="group-btn-divider"></div> */}
              <button
                onClick={handleMarkdownClick}
                className={activeBtn ? "markdown-btn" : "markdown-active-btn"}
              >
                Markdown
              </button>
            </div>
            <button onClick={handleCopyTextClick} className="copy-button">
